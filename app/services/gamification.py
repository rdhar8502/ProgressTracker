...
ACHIEVEMENT_SCHEMAS = {
    ...
    "hours": {
        ...
        "tiers": [
            ...
            {"tier": "Platinum", "threshold": 300, "bonus": 1500, "badge": "Platinum"},
        ]
    },
    "dsa": {
        ...
        "tiers": [
            {"tier": "Bronze", "threshold": 10, "bonus": 100, "badge": "Bronze"},
            {"tier": "Silver", "threshold": 50, "bonus": 250, "badge": "Silver"},
            {"tier": "Gold", "threshold": 150, "bonus": 600, "badge": "Gold"},
    ...
    "sys_design": {
        ...
        "tiers": [
            {"tier": "Bronze", "threshold": 3, "bonus": 100, "badge": "Bronze"},
            {"tier": "Silver", "threshold": 10, "bonus": 250, "badge": "Silver"},
            {"tier": "Gold", "threshold": 20, "bonus": 600, "badge": "Gold"},
            {"tier": "Platinum", "threshold": 28, "bonus": 1500, "badge": "Platinum"},
        ]
    },
    "ai_llm": {
        "title": "AI Specialist",
        ...
        "tiers": [
            {"tier": "Bronze", "threshold": 3, "bonus": 100, "badge": "Bronze"},
            {"tier": "Silver", "threshold": 10, "bonus": 250, "badge": "Silver"},
            {"tier": "Gold", "threshold": 18, "bonus": 600, "badge": "Gold"},
            {"tier": "Platinum", "threshold": 22, "bonus": 1500, "badge": "Platinum"},
        ]
    },
    "github": {
        ...
        "tiers": [
            ...
            {"tier": "Silver", "threshold": 15, "bonus": 250, "badge": "Silver"},
            {"tier": "Gold", "threshold": 30, "bonus": 600, "badge": "Gold"},
            {"tier": "Platinum", "threshold": 40, "bonus": 1500, "badge": "Platinum"},
        ]
    },
    "applications": {
        "title": "Career Hunter",
        ...
        "tiers": [
            ...
            {"tier": "Silver", "threshold": 8, "bonus": 250, "badge": "Silver"},
            {"tier": "Gold", "threshold": 15, "bonus": 600, "badge": "Gold"},
            {"tier": "Platinum", "threshold": 25, "bonus": 1500, "badge": "Platinum"},
        ]
    },
}
